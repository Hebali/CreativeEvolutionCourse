...
UiText::UiText(std::string iText, std::string iFontName, int iFontSize, FontStyle iStyle, FontSuitcase* iSuitcaseRef) :
	UiBase(),
...
void UiText::setText(const string& iText)
{
	// Set string value:
	mText = iText;
	// Set glyphs:
...
void UiText::setTextColor(const ci::ColorA& iColor)
{
	mTextColor = iColor;
}

const ci::ColorA& UiText::getTextColor() const
{
	return mTextColor;
}

void UiText::setHighlightColor(const ci::ColorA& iColor)
{
	mHighlightColor = iColor;
}

const ci::ColorA& UiText::getHighlightColor() const
{
	return mHighlightColor;
}

void UiText::setGuideVisibility(const bool& iVisible)
{
	mGuides = iVisible;
}

const bool& UiText::getGuideVisibility() const
{
	return mGuides;
}